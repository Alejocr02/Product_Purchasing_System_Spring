...
public class CategoryService {
    ...
    public void removeSubcategory(Long parentId, Long subcategoryId) {
        ...
        if (subcategory.getParent() == null || !subcategory.getParent().getCategoryId().equals(parentId)) {
    ...
    public CategoryDTO buildCategoryTree(Long categoryId) {
        return categoryMapper.toDTOWithHierarchy(findCategoryEntityOrThrow(categoryId));
    }
